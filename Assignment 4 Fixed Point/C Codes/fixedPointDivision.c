...
int16_t divFixed(int16_t val1, short int q1, int16_t val2, short int q2, short int format){
    int16_t res;
    res = (int16_t)(val1*(1<<(format -(q1 - q2))) / val2);
    return res;
}
...
int main(){
    ...
    result = divFixed(fixedVal1, q1, fixedVal2, q2, finalFormat);
